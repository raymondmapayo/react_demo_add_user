...
const AddUser = () => {
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            ...
            bday: Yup.date().required("Birthdate is required").nullable(),
        }),
        onSubmit: (values) => {
            axios
        ...
        <div className="d-flex align-items-center justify-content-center" style={{ minHeight: "100vh" }}>
            <div className="container m-8">
                ...
                <form onSubmit={formik.handleSubmit}>
                    ...
                    <label className="form-label">Enter Birthdate:</label>
                    <input className="form-control" type="date" {...formik.getFieldProps("bday")} />
                    {formik.touched.bday && formik.errors.bday && <p className="text-danger">{formik.errors.bday}</p>}
